...
async_resources = ['feffery_captcha', 'feffery_aplayer', 'feffery_dplayer', 'feffery_music_player', 'feffery_emoji_picker', 'feffery_auto_animate', 'feffery_json_viewer', 'feffery_resizable', 'feffery_sortable_list', 'feffery_local_large_storage', 'feffery_fancy_button']
