...
const LazyFefferyHttpRequests = React.lazy(() => import(/* webpackChunkName: "feffery_http_requests" */ '../fragments/FefferyHttpRequests.react'));
...
// 设置默认参数
FefferyHttpRequests.defaultProps = {
}
